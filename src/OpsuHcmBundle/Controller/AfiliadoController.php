...
class AfiliadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $afiliados = $em->getRepository('OpsuHcmBundle:Afiliado')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('OpsuHcmBundle\Form\AfiliadoType', $afiliado);
    ...
    {
        $deleteForm = $this->createDeleteForm($afiliado);
        $editForm = $this->createForm('OpsuHcmBundle\Form\AfiliadoType', $afiliado);
